	...
	private ReadProperties() {
		...
		try {
			...
			try {
				...
				System.out.println("browser value is missing, Please provide the browser value and re-execute the tests");
			...
			try {
				...
				System.out.println("platform value is missing, Please provide the platform value and re-execute the tests");
				e.printStackTrace();
			}
