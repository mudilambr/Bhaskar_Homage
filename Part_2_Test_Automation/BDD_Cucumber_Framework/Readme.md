# Part-2: Homage UI Test Automation Suite
...
Feature file: src\test\resources\featurefiles\HomageCareer.feature
...
*4) How to Run:
==============================
1. Maven command to run the tests: Goto the "BDD_Cucumber_Framework" directory.

$mvn test -Dcucumber.options="--tags @AssignmentTest"
...
BDD_Cucumber_Framework\target\cucumber-html-reports\cucumber-html-reports\overview-features.html
